            ...
            <div className="navbar max-w-7xl mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm absolute z-10 dropdown-content mt-3  p-2 shadow bg-base-100 rounded-box w-52">
                            {links}
                        </ul>
                    </div>
                    <Link className="" to="/">
                        <div className="flex gap-1 items-center">
                            ...
                            <h1 className="btn btn-ghost pt-2 text-xl hidden lg:inline">REstate</h1>
                        </div>
                    </Link>
                </div>
