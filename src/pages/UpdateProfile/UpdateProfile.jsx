                ...
                <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100 p-4">
                    <form className="card-body" onSubmit={UpdateProfileNameImg}>
                        <div className="form-control">
                            ...
                            <input type="text" placeholder={user.displayName || "Name"} name="name" className="input input-bordered" />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Email</span>
                            </label>
                            <input type="email" value={user.email || "Email"} name="email" className="input input-bordered" readOnly />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text">Photo</span>
                            </label>
                            <input type="text" placeholder={user.photoURL || "Photo URL"} name="image" className="input input-bordered" />
                        </div>
